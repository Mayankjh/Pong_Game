...
class Ball:
    def __init__(self,canvas,color,paddle,paddle1):
        ...
        self.id = canvas.create_oval(10,10,29,29,fill=color)
...
class Paddle:
    def __init__(self,canvas,color):
        ...
        self.canvas.bind_all('z',self.turn_right)
...
paddle = Paddle(canvas,'#880e4f')
paddle1 = Paddle1(canvas,'#f50057')
...
while 1:
    ...
    if counter == 10:
        ...
        paddle.y = 0
        paddle1.y = 0
        canvas.create_text(250,180,text="Game Over!", font=32,fill='white')
        canvas.create_text(250,200,text="Congrats Player1 you Win!", font=32,fill='white')
        canvas.create_text(250,213,text="Score:" + str(counter) + " - " + str(counter1), font=32,fill='white')
    if counter == 10:
        ball.x = 0
        ball.y = 0
        paddle.y = 0
        paddle1.y = 0
        canvas.create_text(250,200,text="Game Over!", font=32,fill='white')
        canvas.create_text(250,200,text="Congrats Player2 you Win!", font=32,fill='white')
        canvas.create_text(250,213,text="Score:" + str(counter) + " - " + str(counter1), font=32,fill='white')
